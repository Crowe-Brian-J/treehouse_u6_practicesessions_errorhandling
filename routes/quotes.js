...
router.get('/:id', (req, res, next) => {
  ...
  */
  const quote = quotes[req.params.id] // Lookup the quote by id

  if (quote) {
    // If the quote exists, render the quote view
    res.render('quote', { title: 'Code Quote', quote })
  } else {
    // If not, create a 404 error and forward it
